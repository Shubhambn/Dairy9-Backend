...
router.get('/retailer/my-orders', getRetailerOrders); // 👈 MISSING ROUTE
router.get('/retailer/active-orders', getRetailerActiveOrders);
router.get('/retailer/order-history', getRetailerOrderHistory);
router.get('/retailer/stats', getRetailerOrderStats); // 👈 MISSING ROUTE
...
router.put('/retailer/:id/status', (req, res, next) => {
  ...
  next();
}, updateOrderStatusByRetailer); // 👈 MISSING ROUTE
...
router.put('/:id/deliver', (req, res, next) => {
  ...
  next();
}, markOrderDelivered); // 👈 MISSING ROUTE
